...
static inline ptr_t _align_page(ptr_t address)
{
	...
	/* https://zhuanlan.zhihu.com/p/562076632
	    (address + 2^ORDER - 1) & ~(2^ORDER - 1) 
	<=> (address + 2^ORDER - 1) / 2^ORDER * 2^ORDER
	make address round up to a multiple of 2^ORDER
	  2^ORDER      = 0000 0000 0000 0000 0000 1000 0000 0000
	 (2^ORDER - 1) = 0000 0000 0000 0000 0000 0111 1111 1111
	~(2^ORDER - 1) = 1111 1111 1111 1111 1111 1000 0000 0000
	*/
}
